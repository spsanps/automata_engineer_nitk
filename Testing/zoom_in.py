...
class Sensor(VirtualSensor):
    ...
    def initialise_stream(self):
        self.video_stream = VAC(cv2.imread('image_processed.jpg'))
    ...
    def find_red_cell(self):
        ...
        :return:
        """
        lower = np.array([0, 75, 75], dtype=np.uint8)
    ...
    def identity_robot(self, position, f, auto_thersh=True):
        """
        ...
        if position is None:
            ...
            cv2.imwrite("smallhjljl_square.jpg", cropped_image)
        ...
        def sensor_existence():
            ...
            while self.running:
                ...
                if f is None:
                    ...
                    continue
                f = self.get_normalized_data(f)
                circles = self.identity_robot(self.get_last_position(), f)
                if circles == -1: continue
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print s.get_all_information(s.identity_robot(p, crop_img))
